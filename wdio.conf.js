...
exports.config = {
    ...
    suites: {
        ...
        suiteA: [
            "./src/features/commonWealthBank.feature.feature"           
    ...
    //     // make sure that not more than 5 instance gets started at a time. //internet explorer //chrome
    //     maxInstances: 5,         
    ...
    cucumberOpts: {
        ...
        timeout: process.env.DEBUG === "true" ? 24 * 60 * 60 * 1000 : 90000
    },
    ...
    afterStep: function (uri, feature, { error, result, duration, passed }, stepData, context) {
        const path = './errorScreenShots/' + Date.now() + '.png';
    ...
    onPrepare: function (config, capabilities) {
        ...
        global.reportAggregator = reportAggregator;
            ...
            console.log('this is error on Prepare: ',error)
        }
    },
    ...
    onComplete: function(exitCode, config, capabilities, results) {
        (async () => {
            ...
            //console.log(global.reportAggregator.reports[0].info)
        }
        catch(error){
            console.log('this is error in on complete: ',error)
        }
        })();
    },
};
